...
After completing windows setup then run windows command line (cmd)
  cd daemon
  Thorcoind
You would need to create a configuration file Thorcoin.conf in the default
wallet directory. Grant access to Thorcoind.exe in anti-virus and firewall
...
Thorcoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
Thorcoind stop
Start up the new Thorcoind (0.3.0).
