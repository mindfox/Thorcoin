...
unsigned int nStakeTargetSpacing = 60; //  32 second block spacing
int64 nChainStartTime = 1393167677;
...
const string strMessageMagic = "Thorcoin Signed Message:\n";
...
// Thorcoin: increasing Nfactor gradually
...
int64 GetProofOfWorkReward( int nHeight, uint256 prevHash)
{
        ...
        int rand = generateMTRandom(seed, 200000);
        int rand1 = 0;
        ...
        {   
            ...
            cseed_str = prevHash.ToString().substr(5,7);
                ...
                seed = hex2long(cseed);
                rand1 = generateMTRandom(seed, 200000);
                if(rand1 < 10000)
                nSubsidy = rand + 10000 * COIN;
                else if(rand1 > 10000)
                nSubsidy = rand1 * COIN;  
            }
...
static const int64 nTargetTimespan = 1 * 60 * 60;  // one day
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Thorcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
  ...
  //vMerkleTree: 05b4eb8ba8 
        ...
        // Genesis block
        const char* pszTimestamp = "Thorcoin- ASIC Resistance Strong";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xda96e5278c50b29b5aef425c0a30d3f2323460fbbb8d3eafebdf812a635b80ee"));
        block.print();
